...
#python3 main.py --load_config=fcn8s_2stream_shufflenet_train.yaml train Train2Stream FCN8s2StreamShuffleNet3
...
#python3 main.py --load_config=fcn8s_2stream_shufflenet_train.yaml train Train2Stream FCN8s2StreamShuffleNet3
python3 main.py --load_config=fcn8s_2stream_shufflenet_test.yaml inference Train2Stream FCN8s2StreamShuffleNet3
